...
function getSelf(arg) {
    ...
    self.server = udplib.createSocket(self.udplib? self.udplib:"enet", incomingDgram, self.port ? parseInt(self.port) : 0, self.ip || '0.0.0.0', self.interface, function(addr){
